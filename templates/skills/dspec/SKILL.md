...
| `__DS_CMD_UPDATE__` | take the newest dspec from npm and rebuild its commands, skill and hooks here |
...
**Taking a newer dspec**: `__DS_CMD_UPDATE__`, or in a terminal `dspec update` then `dspec init`.
